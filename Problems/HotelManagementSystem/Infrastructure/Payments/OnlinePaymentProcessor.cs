...
public sealed class OnlinePaymentProcessor : IPaymentProcessor
{
    public Payment Process(PaymentRequest request)
    {
        var payment = new Payment(Guid.NewGuid(), request.ReservationId, request.Amount, PaymentMethod.Online);
